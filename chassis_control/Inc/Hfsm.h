...
// --- 向上层发送的动作指令 ---
typedef enum {
    FLAG_GRAB_KFS_FRONT_HIGH_KEEP = 1,  // 二区取前方高200的块并保存
    ...
    FLAG_GRAB_KFS_FRONT_HIGH_REMOVE,  // 二区取前方高200的块并移走
    FLAG_GRAB_KFS_FRONT_LOW_REMOVE,
    FLAG_GRAB_KFS_LEFT_HIGH_REMOVE,
    FLAG_GRAB_KFS_LEFT_LOW_REMOVE,
    FLAG_GRAB_KFS_RIGHT_HIGH_REMOVE,
    FLAG_GRAB_KFS_RIGHT_LOW_REMOVE,
